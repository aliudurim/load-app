                ...
                if (this != null && moveToFirst()) {
                    ...
                    when (getInt(getColumnIndex(DownloadManager.COLUMN_STATUS))) {
                        DownloadManager.STATUS_FAILED -> {
                            viewBinding.mainContent.loadingButton.changeButtonState(ButtonState.Completed)
                        }
                        ...
                        DownloadManager.STATUS_RUNNING -> {
                            viewBinding.mainContent.loadingButton.changeButtonState(ButtonState.Loading)
                        }
